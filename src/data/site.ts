export const site = {
  ...
  subtitle:
    "Neformální rozhovory s lidmi, kteří píšou kód, tvoří software, zkouší nové věci a chtějí mít z práce radost.",
  description:
  ...
  about: {
    lead:
      "Kuchyňkový pokec vývojářů a dalších lidí z oboru vývoje software. To je podcast Lidi za kódem",
    body:
  ...
  author: {
    ...
    // PLACEHOLDER: Text uprav podle finální bio autora.
  ...
  // Připraveno pro budoucí sekci, zatím se na stránce nevykresluje.
  latestEpisode: null
} as const;
